...
// 1. useState é substituído por ref para criar um estado reativo.
const expanded = ref(true);

// 2. O Context API do React é substituído pelo provide/inject do Vue.
//    Fornecemos o estado 'expanded' para todos os componentes descendentes.
